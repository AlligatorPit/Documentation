...
.. include:: ../entities_info/CSanta.rst
...
* readonly ``m_soRunning``
* bool ``m_bRunSoundPlaying``
* readonly ``m_penTemplate0``
* readonly ``m_penTemplate1``
* readonly ``m_penTemplate2``
* readonly ``m_penTemplate3``
* readonly ``m_penTemplate4``
* bool ``m_bDied``
* string ``m_fnmCustomSantaModel``
