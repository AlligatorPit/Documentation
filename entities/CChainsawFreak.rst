...
Inherits: `CEnemyRunInto <CEnemyRunInto.html>`_

.. include:: ../entities_info/CChainsawFreak.rst
...
Members inherited from CEnemyRunInto
------------------------------------
...
* readonly ``m_fAttackRotateRunInto``
