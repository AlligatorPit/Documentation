...
.. include:: ../entities_info/CExotechLarva.rst

Members
-------

* readonly ``m_penMarkerNew``
* readonly ``m_penMarkerOld``
* float ``m_fStopRadius``
* float ``m_fStretch``
* float ``m_fLarvaHealth``
* float ``m_fRechargePerSecond``
* readonly ``m_ltTarget``
* readonly ``m_penFirstRechargeTarget``
* bool ``m_bRechargedAtLeastOnce``
* vec3 ``m_vFirePosLeftPlasmaRel``
* vec3 ``m_vFirePosRightPlasmaRel``
* vec3 ``m_vFirePosTailRel``
* vec3 ``m_vFirePosLeftLaserAbs``
* vec3 ``m_vFirePosRightLaserAbs``
* bool ``m_bLeftArmActive``
* bool ``m_bRightArmActive``
* readonly ``m_iExplodingArm``
...
* vec3 ``m_vLeftLaserTarget``
* vec3 ``m_vRightLaserTarget``
* bool ``m_bInvulnerable``
* readonly ``m_penLeftArmDestroyTarget``
* readonly ``m_penRightArmDestroyTarget``
