...
Inherits: `CEnemyFly <CEnemyFly.html>`_

.. include:: ../entities_info/CWoman.rst

Members
-------

* bool ``m_bKamikazeCarrier``
* float ``m_rKamikazeDropDistance``
* bool ``m_bKamikazeAttached``

Members inherited from CEnemyFly
--------------------------------
...
* readonly ``m_aFlyWalkRotateSpeed``
* float ``m_fFlyAttackRunSpeed``
* readonly ``m_aFlyAttackRotateSpeed``
* float ``m_fFlyCloseRunSpeed``
* readonly ``m_aFlyCloseRotateSpeed``
