...
.. include:: ../entities_info/CHeadman.rst
...
* bool ``m_bExploded``
* bool ``m_bAttackSound``
* readonly ``m_iLoopRand``
* readonly ``m_iLoopCounter``
* readonly ``m_iLoopAngle``
* readonly ``m_ptLoopProjectile``
* bool ``m_iCustomFireWait``
* readonly ``m_iCustomAngle``
* readonly ``m_iCustomNumber``
* readonly ``m_iCustomFireCounter``
